...
export const SITE_EXPLORER_PLOTS: ExplorerPlotCopy[] = [
  {
    ...
    name: 'Office',
    summary:
      'A commercial office with a service yard. Roof and yard water is collected, cleaned and slowed down before it leaves the site, while the foul drain runs on its own line to the sewer.',
    products: [
      {
        id: 'office-surface-chamber',
        name: 'Inspection chamber',
        role: 'Access to the surface water drain where the roof downpipes join it.',
      ...
      },
      {
        ...
        role: 'Spins silt, litter and oil out of the yard runoff before it travels any further.',
        slug: 'rhinoceptor',
      ...
      },
      {
        ...
        role: 'Holds the discharge to the rate agreed for the site, so the network downstream is not overwhelmed.',
        slug: 'flow-control',
      ...
      },
      {
        ...
        role: 'Access to the foul drain from the washrooms and kitchen before it joins the sewer.',
        slug: 'inspection-chamber',
        productId: 'chamber',
      },
    ],
  },
  {
    ...
    name: 'Car park',
    summary:
      'A multi-storey car park and its surface bays. Runoff from paving carries silt and hydrocarbons, so it is filtered and trapped at source, then released at a controlled rate.',
    products: [
      {
        id: 'car-park-rhinopod',
        name: 'RhinoPod gully filter',
        role: 'Floats in the gully and catches silt, litter and hydrocarbons where the water first drains.',
        slug: 'rhinopod',
        productId: 'rhinopod',
      },
      {
        ...
        role: 'Lets silt settle in its sump so it can be lifted out, not washed on into the pipes.',
      ...
      },
      {
        ...
        role: 'Limits the outflow from the paved area without the small opening an orifice would need.',
        slug: 'flow-control',
        productId: 'flow-control',
      },
    ],
  },
  {
    ...
    name: 'Retail',
    summary:
      'A parade of shops with a cafe on the end. Kitchen waste water carries fats, oils and grease, which are held back before they reach the foul sewer.',
    products: [
      {
        id: 'retail-surface-chamber',
        name: 'Inspection chamber',
        role: 'Brings the roof downpipes from the parade into the surface water drain.',
        slug: 'inspection-chamber',
        productId: 'chamber',
      },
      {
        ...
        name: 'Grease trap',
        role: 'Catches fats, oils and grease on the cafe kitchen drain before they can set hard in the pipes.',
        slug: 'grease-trap',
      ...
      },
      {
        ...
        name: 'Foul inspection chamber',
        role: 'Access to the shared foul drain, downstream of the grease trap.',
        slug: 'inspection-chamber',
        productId: 'chamber',
      },
    ],
  },
  {
    ...
    name: 'House',
    summary:
      'A detached house sitting lower than the sewer it drains to. Foul water is pumped up to a gravity connection, and a drawpit gives access to the duct for the driveway charger.',
    products: [
      {
        id: 'house-surface-chamber',
        name: 'Inspection chamber',
        role: 'Access to the roof drainage on the surface water side.',
        slug: 'inspection-chamber',
        productId: 'chamber',
      },
      {
        ...
        role: 'Collects foul water where there is no fall to the sewer and pumps it up to a gravity drain.',
        slug: 'pump-station',
      ...
      },
      {
        ...
        name: 'Foul inspection chamber',
        role: 'Takes the pumped rising main and lets the foul water carry on to the sewer by gravity.',
        slug: 'inspection-chamber',
        productId: 'chamber',
      },
      {
        ...
        role: 'An access pit on the cable duct to the car charger, so cables can be pulled through later.',
        slug: 'drawpit',
        productId: 'drawpit',
      },
    ],
