...
export function CTABanner() {
  return (
    <section className="py-24 md:py-28 bg-navy-d">
      <div className="mx-auto max-w-3xl px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight">
          Need our help?
        </h2>
        <p className="mt-5 text-white/60 text-lg leading-relaxed max-w-lg mx-auto">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-5">
          ...
          <Link
            href="/contact"
            className="rounded-full border border-white/25 hover:border-white/50 text-white px-8 py-4 text-base font-bold transition-colors"
          >
            Get in Touch
          </Link>
        </div>
