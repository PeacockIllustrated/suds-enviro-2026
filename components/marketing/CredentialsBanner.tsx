        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div>
            <div className="flex items-baseline gap-6 mb-6">
              <span className="text-7xl md:text-8xl font-extrabold text-green leading-none">
                40+
              </span>
            ...
            <div className="flex items-baseline gap-6">
              <span className="text-4xl md:text-5xl font-extrabold text-green/80 leading-none">
                100%
              </span>
